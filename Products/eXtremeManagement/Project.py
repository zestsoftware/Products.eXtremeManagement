...
schema=Schema((
    ...
    StringField('customers',
        widget=SelectionWidget(
            label='Customers',
            label_msgid='eXtremeManagement_label_customers',
            description_msgid='eXtremeManagement_help_customers',
            i18n_domain='eXtremeManagement',
        )
    ),

    IntegerField('attribute_30',
        widget=IntegerWidget(
            label='Attribute_30',
            label_msgid='eXtremeManagement_label_attribute_30',
            description_msgid='eXtremeManagement_help_attribute_30',
            i18n_domain='eXtremeManagement',
        )
    ),
...
class Project(BaseFolder):
    ...
    meta_type                  = 'Project'
    portal_type                = 'Project'
    allowed_content_types      = ['ProjectFolder']
